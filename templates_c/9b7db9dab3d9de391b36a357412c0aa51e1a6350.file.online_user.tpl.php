<?php /* Smarty version Smarty-3.1.15, created on 2015-10-26 19:27:35
         compiled from "./templates/new_red/online_user.tpl" */ ?>
<?php /*%%SmartyHeaderCode:92837717556254c6e95a724-24656929%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9b7db9dab3d9de391b36a357412c0aa51e1a6350' => 
    array (
      0 => './templates/new_red/online_user.tpl',
      1 => 1445883995,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '92837717556254c6e95a724-24656929',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_56254c6e9f85a5_21879766',
  'variables' => 
  array (
    'lang' => 0,
    'ao' => 0,
...
<?php if ($_valid && !is_callable('content_56254c6e9f85a5_21879766')) {function content_56254c6e9f85a5_21879766($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['templa']->value)."/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['templa']->value)."/left.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
		...
		<h1 class="ng"><?php echo $_smarty_tpl->tpl_vars['lang']->value[279];?>
 (<?php echo $_smarty_tpl->tpl_vars['ao']->value;?>
)</h1>
		
		<p>

<center>
<?php if ($_smarty_tpl->tpl_vars['ao']->value==0) {?><b>Brak użytkowników online.</b><?php }?>
<table >
<tr>
...
<table border="0">
<tr>
<td style="width:20px;height:20px;" class="td_hover" align="center"><?php if ($_smarty_tpl->tpl_vars['strona']->value>1) {?><a href="online/s-1" title="<?php echo $_smarty_tpl->tpl_vars['lang']->value[654];?>
"><<</a><?php } else { ?><<<?php }?></td>
<td style="width:20px;height:20px;" class="td_hover" align="center"><?php if ($_smarty_tpl->tpl_vars['page_m']->value>=1) {?><a href="online/s-<?php echo $_smarty_tpl->tpl_vars['page_m']->value;?>
...
<td style="width:20px;height:20px;" class="td_hover" align="center"><a href="online/s-<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['strona']['index']+1;?>
...
<td style="width:20px;height:20px;" class="td_hover" align="center"><?php if ($_smarty_tpl->tpl_vars['page_p']->value<=$_smarty_tpl->tpl_vars['podstron']->value) {?><a href="online/s-<?php echo $_smarty_tpl->tpl_vars['page_p']->value;?>
"  title="<?php echo $_smarty_tpl->tpl_vars['lang']->value[656];?>
: <?php echo $_smarty_tpl->tpl_vars['page_p']->value;?>
">></a><?php } else { ?>><?php }?></td>
<td style="width:20px;height:20px;" class="td_hover" align="center"><?php if ($_smarty_tpl->tpl_vars['strona']->value!=$_smarty_tpl->tpl_vars['podstron']->value) {?><a href="online/s-<?php echo $_smarty_tpl->tpl_vars['podstron']->value;?>
