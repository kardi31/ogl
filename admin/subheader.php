...
<td style="border: 1px solid rgb(204, 204, 204);width:80px;" class="td_hover" align="center" valign="top"><a href="index.php?page=filmy" style="text-decoration:none;font-size:12px;"><img src="style/images/play48.png"><br>Filmy</a></td>
<td style="border: 1px solid rgb(204, 204, 204);width:80px;" class="td_hover" align="center" valign="top"><a href="index.php?page=reklama" style="text-decoration:none;font-size:12px;"><img src="style/images/adv48.png"><br>Reklama</a></td>
