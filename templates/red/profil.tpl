...
{if $user_id>=1}
		<h1 class="ng">{$lang[21]} {$login} <small style="font-size:12px;">{if $get_user_online>=1}<b style="color:green;">{$lang[22]}</b>{else}<b style="color:silver;">{$lang[23]}</b>{/if}</small></h1>
		<p>
...
<div class="td_hover" >{if $profil_ile_znajomi>=1}<a href="profil/{$loginn}/{$id}/znajomi">{$lang[24]} ({$profil_ile_znajomi})</a>{else}{$lang[24]} (0){/if}</div>
<div class="td_hover">{if $profil_ile_galeria>=1}<a href="profil/{$loginn}/{$id}/zdjecia">{$lang[25]} ({$profil_ile_galeria})</a>{else}{$lang[25]} (0){/if}</div>
<div class="td_hover">{if $profil_ile_filmy>=1}<a href="profil/{$loginn}/{$id}/filmy">{$lang[658]} ({$profil_ile_filmy})</a>{else}{$lang[658]} (0){/if}</div>
<div class="td_hover">{if $profil_ile_imprezy>=1}<a href="profil/{$loginn}/{$id}/imprezy">{$lang[26]} ({$profil_ile_imprezy})</a>{else}{$lang[26]} (0){/if}</div>
{if $gift_on==1}<div class="td_hover">{if $profil_ile_prezenty>=1}<a href="profil/{$loginn}/{$id}/prezenty">{$lang[27]} ({$profil_ile_prezenty})</a>{else}{$lang[27]} (0){/if}</div>{/if}
</td>
