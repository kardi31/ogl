...
{$lang[615]} <b>{$dnicenasms}{$lang[616]}</b>.
<br><br><br>
...
{$lang[626]} 
<br><br>
<a href="do_kup.php?id={$dniid}&p=v" style="font-weight:bold;font-size:14px;text-decoration:none;">{$lang[627]} </a>
